            ...
            while True:
                ...
                if line.startswith("option name"):
                    ...
                    if "spin" in line:
                        ...
                        parameters.append(Parameter(name, min_val, max_val, True))
                elif line == "uciok":
                    break
...
def main():
    ...
    for generation in range(1):
        ...
        pbil.update_probabilities(population[sorted_indices[0]], population[sorted_indices[-1]])
        print(f"Generation {generation}: Best Score = {fitness_scores[sorted_indices[0]]}")
