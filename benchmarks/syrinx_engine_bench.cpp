...
class BM_Syrinx : public benchmark::Fixture {
protected:
...
BENCHMARK_F(BM_Syrinx, EvalStartPos)(benchmark::State& state) {
    for (auto _ : state) {
...
BENCHMARK_F(BM_Syrinx, EvalComplexPos)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, EvalPawnStruct)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, EvalKingSafe)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, AlphaBetaSearch)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, MateInOneSearch)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, EndgameEval)(benchmark::State& state) {
...
BENCHMARK_F(BM_Syrinx, MoveGen)(benchmark::State& state) {
    int moveNum = 0;
    for (auto _ : state) {
